...
export interface ScaleComponentMap {
  x?: ScaleComponent;
  y?: ScaleComponent;
  row?: ScaleComponent;
  column?: ScaleComponent;
  color?: ScaleComponent;
  size?: ScaleComponent;
  shape?: ScaleComponent;
}
...
export function compileScale(model: Model): ScaleComponentMap {
  return model.channels().reduce(function(scale: ScaleComponentMap, channel: Channel) {
